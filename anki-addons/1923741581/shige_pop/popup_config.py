...
THE_ADDON_NAME = "Zoom for Anki 25 (Fixed by Shige)"
SHORT_ADDON_NAME = "Zoom for Anki 25 (Fixed by Shige)"
IS_CHANGE_LOG = None
...
NEW_FEATURE = """
[1] Enhanced (2025-01-08)
    - Added separate zoom levels for questions and answers.
        - Can be disabled in options.
    - Added auto-saving of zoom levels with Ctrl + Mouse Wheel.
        - (Editor, Stats, Reviewer, Home, Overview)
    - Organized options.

[1] Bug Fixed
    - Fixed the issue where "Do not auto save zoom" was not working.
"""
